...
% -------------------------------------------------------------------------
function [curve, all_bsf_fit_vals,all_fun_no_fit_errorval] = MadDE(num_runs,fhd,C,problem_size,funcs,max_nfes,optimum)
...
for func_no = funcs
    ...
    all_bsf_fit_vals = zeros(1,num_runs);
    curve = zeros(1,max_nfes);
    all_fun_no_fit_errorval = zeros(1,num_runs);
   ...
   for run_id = 1 : num_runs
         ...
         pop_size = 100;
          ...
          all_bsf_fit_vals(:,run_id) = bsf_fit_var;
    ...
    all_bsf_fit_vals = all_bsf_fit_vals';
    all_fun_no_fit_errorval = allerrorvals(end,:);
    % Print Results
    ...
    fprintf('all_bsf_fit_vals_min:\t%e\n',min(all_bsf_fit_vals));
    fprintf('all_bsf_fit_vals_median:\t%e\n',median(all_bsf_fit_vals));
    fprintf('all_bsf_fit_vals_mean:\t%e\n',mean(all_bsf_fit_vals));
    fprintf('all_bsf_fit_vals_max:\t%e\n',max(all_bsf_fit_vals));
    fprintf('all_bsf_fit_vals_std:\t%e\n',std(all_bsf_fit_vals));
    
  
    % Saving the solutions
    file_name=sprintf('Results/allerrorvals_%s_%s_%s.txt',Alg_Name,int2str(func_no),int2str(problem_size));
    save(file_name, 'allerrorvals', '-ascii');
    

    file_name=sprintf('Results\\all_bsf_fit_vals_%s_%s_%s.txt',Alg_Name,int2str(func_no),int2str(problem_size));
    save(file_name, 'all_bsf_fit_vals', '-ascii');
